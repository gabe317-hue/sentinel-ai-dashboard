 ...
 *   4. ADJUDICACION_DIRECTA — Direct award (no competition) above L. 500,00
 *
 * Severity:
...
function buildAlertRecord(contract, patterns, severity) {
  ...
  return {
    ...
    budget_amount: contract.presupuesto > 0 ? contract.presupuesto : null, // SOBRECOSTO: original budget from planning.budget
