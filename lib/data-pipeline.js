...
async function fetchAllContracts() {
  console.log(`[Pipeline] Fetching ${PAGES_TO_FETCH} pages sequentially from SEFIN...`);
  ...
  // causing all requests to time out. Sequential requests each complete in ~10-15s.
  const allContracts = [];
...
function buildAlertRecord(contract, patterns, severity) {
  ...
  return {
    ...
    entity_name: contract.entidad,           // dashboard reads a.entity_name
